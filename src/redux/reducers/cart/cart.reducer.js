...
const cartReducer = (state = INITIAL_STATE, action) => {
  switch(action.type) {
    ...
    case INCREASIN_QUANTITRY_CHOOSED_ITEM:
      return {
        ...state,
        collections: increasinQuantityChoosedItem(state.collections, action.payload)
      };
    case REDUCING_QUANTITRY_CHOOSED_ITEM:
      return {
        ...state,
        collections: reducingQuantityChoosedItem(state.collections, action.payload)
      }
    case REMOVE_CHOOSED_ITEM:
      return {
        ...state,
        collections: removeChoosedItemFromCllections(state.collections, action.payload)
      }; 
    default:
      return state;
  };
